	...
	if ($envoi == 'yes')
	{
		...
		else
		{
			...
			if($msg=='')
			{
				...
				vous a invité à rejoindre la communauté Mozilla Tunisia et il a vous a envoyer le message suivant : <br/><br/>
				
				<strong>Message personnel :</strong><p style="padding-left:50px;">'.$desc.'</p>
				
				<br/>Rejoindre Mozillians:  http://join.mozilla-tunisia.org/register.php?code='.$code.'&mail='.$mail.' <br/>											
